...
# $$  \frac{\partial^2 u}{\partial y^2} + \frac{\partial^2 u}{\partial x^2}=x^2+y^2.$$
# with the Boundary Conditions:
# $$ u(x,0)=0, \ \ \ \ \ 0 \leq x \leq 1, \text{ lower},$$
# $$ u(x,1)=0, \ \ \ \ \ 0 \leq x \leq 1, \text{ upper},$$
# $$ u(0,y)=0, \ \ \ \ \ 0 \leq y \leq 1, \text{ left},$$
# $$ u(1,y)=0, \ \ \ \ \ 0 \leq y \leq 1, \text{ right}.$$
# 
...
# $$ w[i,0]=0, \text{ for } i=0,...,10, \text{ upper},$$  
# $$ w[i,N]=0, \text{ for } i=0,...,10,  \text{ lower},$$
# $$ w[0,j]=0, \text{ for } j=0,...,10,   \text{ left},$$
# $$ w[N,j]=0, \text{ for } i=0,...,10,\text{ right}. $$
# 
